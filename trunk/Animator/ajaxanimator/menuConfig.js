    ...
    menuModel.addItem(7, 'User' ,'' ,'',0,'',''  ,'',150);
    ...
    menuModel.addItem(51 , 'Delete Keyframe','../images/delete.png' ,'',5,'','removeKeyframe()');
	...
	canvasContextMenuModel.addItem(5,'Undo','../images/arrow_undo.png','','',false,'undo()');
	canvasContextMenuModel.addItem(6,'Drawing Tool','../images/paintbrush.png','','',false,'');
	
	canvasContextMenuModel.addItem(50,'Select','../images/select.gif','',6,false,'setMode("select", "Selection")');
	canvasContextMenuModel.addItem(51,'Rectangle','../images/rectangle.gif','',6,false,'setMode("rect", "Rectangle")');
	canvasContextMenuModel.addItem(52,'Round Rectangle','../images/roundrect.gif','',6,false,'setMode("roundrect", "Rounded Rectangle")');
	canvasContextMenuModel.addItem(53,'Ellipse/Circle','../images/circle.gif','',6,false,'setMode("ellipse", "Ellipse/Circle")');
	canvasContextMenuModel.addItem(54,'Line','../images/line.gif','',6,false,'setMode("line", "Line")');
