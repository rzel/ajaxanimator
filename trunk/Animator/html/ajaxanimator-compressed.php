...
<script type="text/javascript" src="http://pagead2.googlesyndication.com/pagead/show_ads.js">
</script></td> <td> <div id="CanvasContainer" style="margin-left: auto; margin-right: auto;width: 480px; height: 272px;overflow:auto"></div> <div id="playControls"> <center> <img alt="&lt;--" src="../images/player_rew.png" onclick="gotoframe(currentFrameSelection-1,1);"> <img alt="play" src="../images/player_play.png" onclick="playAnimation();"> <img alt="stop" src="../images/player_stop.png" onclick="stopAnimation();"> <img alt="--&gt;" src="../images/player_fwd.png" onclick="gotoframe(currentFrameSelection+1,1);"> </center> </div> <center> <br> <div style="font-size:x-small" id="status"></div> </center> </td> <td>
<script type="text/javascript"><!--
google_ad_client = "pub-9279109908159341";
google_ad_width = 120;
google_ad_height = 240;
