...
Extremely easy-to-use cross-browser tooltips.
...
which means you can put really important stuff into tooltips,
since, unlike JavaScript strings, such HTML content is covered by
web search engines.
...
config. FadeIn			= 900		// Fade-in duration in ms, e.g. 400; 0 for no animation
config. FadeOut 		= 2000
...
tt_over,				// Reference to the hovered HTML element
...
function tt_SetOpa(t_css, t_opa)
{
	...
	{
		// Hack for bugs of IE:
		// A DIV cannot be made visible in a single step in case that an
