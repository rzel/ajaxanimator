...
{"app":"Ajax Animator","build":71,"release":"0.2","dev":true,"stability":"Pre Alpha","date":1211831883.09}
/*STOP*/ )
/*End Of File*/
...
Ext.apply(this,{
    ...
    width:50,
    border:true,
    items: [{xtype:"toolbox"},{xtype: "label",style: "font-size: xx-small; margin-left: 3px", text: "Line"},
...
{xtype: "colorfield", width: 48, defaultColor:"000000",listeners: {"select":function(){console.log("w00t")}}},
{xtype: "label",style: "font-size: xx-small; margin-left: 3px", text: "Fill"},
{xtype: "colorfield", width: 48, defaultColor:"FF0000",listeners: {"select":function(){console.log("w00t")}}}
]
  })
   this.initialConfig.collapsible = true; //bugfix from http://outroot.com/extjs/bug1/ 
