...
{"app":"Ajax Animator","build":89,"release":"0.2","dev":true,"stability":"Pre Alpha","date":1211840888.89}
/*STOP*/ )
/*End Of File*/
...
Ax.ColorPanel = Ext.extend(Ext.Panel,{
  initComponent: function(){
    ...
    items: [
      ...
      {xtype: "slider", maxValue: 30,plugins: this.SliderTip},
      ...
      var win = new Ext.ux.ColorDialog({
        ...
        resizable: false,
        buttons: [{text: "Fill Color"},{text: "Line Color"},{text: "Close"}]
      })
      win.show()
