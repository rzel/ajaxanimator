...
Ax.v = /*START*/
{"build":47,"release":"0.2","dev":true,"date":1210113832.77}
/*STOP*/
...
Ax.aboutWindow = new Ext.Window({
	...
	""
		...
		html: "GPL v3 (http://www.gnu.org/licenses/gpl-3.0.txt) <br> <i>Please don't sue me</i>"
	}]
}]
});
...
cm:/*BEGIN*/new Ext.grid.ColumnModel([{header: 'Comment',  sortable: true, dataIndex: 'comment'}])/*END*/
}
  }]
})
