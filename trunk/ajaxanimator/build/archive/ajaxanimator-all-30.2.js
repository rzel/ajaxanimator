...
Ax.v = /*START*/
{"build":30,"release":"0.2","dev":true,"date":1209411625.34}
/*STOP*/
...
Ax.aboutWindow = new Ext.Window({
    ...
    items:[{
		...
		'<i>Note: This is not fully comprehensive of everything used</i><br>'+
		...
		title: 'License',
		html: "GPL v3 (http://www.gnu.org/licenses/gpl-3.0.txt)"
	}]
}]
});
