...
{"app":"Ajax Animator","build":63,"release":"0.2","dev":true,"stability":"Pre Alpha","date":1211808372.97}
/*STOP*/ )
/*End Of File*/
    ...
    this.cellActions = new Ext.ux.grid.CellActions({
      callbacks: {
        "tb_delete":function(grid,record,action,value){
          ...
          msg('Callback: delete layer', 'You have clicked: <b>{0}</b>, action: <b>{1}</b>', value, action);
        }
      }
    });
    Ext.apply(this,{
