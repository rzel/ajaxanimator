...
Ax.preload = function(){
Ax.viewport.findById("canvas-sb").getBottomToolbar().setText("Preloading Icons")
...
Ax.viewport.findById("canvas-sb").getBottomToolbar().setText("Preloaded "+x+" out of "+loader.length)
