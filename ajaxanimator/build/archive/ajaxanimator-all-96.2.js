...
{"app":"Ajax Animator","build":96,"release":"0.2","dev":true,"stability":"Pre Alpha","date":1211921257.63}
/*STOP*/ )
/*End Of File*/
...
Ax.ColorPanel = Ext.extend(Ext.Panel,{
  initComponent: function(){
    ...
    items: [
      ...
      {xtype: "slider", maxValue: 30,plugins: this.SliderTip, value: Ax.Color.width, listeners: {
