...
{"app":"Ajax Animator","build":65,"release":"0.2","dev":true,"stability":"Pre Alpha","date":1211810429.94}
/*STOP*/ )
/*End Of File*/
  ...
  initComponent: function(){
    this.cellActions = new Ext.ux.grid.CellActions({
      callbacks: {
        ...
        "tb_newlayer": function(grid,record,action,value){
          Ax.addLayer()
        }
      }
    });
